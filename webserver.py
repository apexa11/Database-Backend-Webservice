...
class WebServerHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.path.endswith('/restaurants/new'):
            ...
            output += '''<form method='POST' enctype='multipart/form-data' action='/restaurants/new'><input name="newRestaurantName" type="text" placeholder = "NewRestaurantName"><input type="submit" value="Create"> </form>'''
            output += ' </body></html>'
            self.wfile.write(output)
            print output
            return
        ...
        if self.path.endswith('/edit'):
            ...
            if myRestaurantQuery:
                ...
                output += '</h1>'
                output += "<form method='POST' enctype='multipart/form-data' action='/restaurants/%s/edit'>"  % restaurantsIdPath
        ...
        if self.path.endswith('/delete'):
            ...
            if myRestaurantQuery != []:
                ...
                output += '</h1>'
                output += "<form method='POST' enctype='multipart/form-data' action='/restaurants/%s/delete'>" % restaurantsIdPath
